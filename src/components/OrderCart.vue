    ...
    methods: {
        ...
        handleSaveOrder() {
            ...
            if (this.orderType == 'delivery') {
                ...
                formData.append("order_channel_id", "3b696cbc-10ef-13ed-a261-0242ac120002");
                formData.append('dining_table_id', "3b696cbc-10ef-11ed-a261-0242ac120002");
            }
            else {
                ...
                localOrder.push(
                    {
                        ...
                        order_channel_id: "3b696cbc-10ef-11ed-a261-0242ac120002",
                        name: this.name,
                        phone: this.phone,
                ...
                localOrder.push(
                    {
                        ...
                        quantity: this.itemsInCart.length,
                        total_price: this.cartTotal,
                        order_channel_id: "3b696cbc-10ef-13ed-a261-0242ac120002",
                        dining_table_id: "3b696cbc-10ef-11ed-a261-0242ac120002",
                        items: this.itemsInCart,
                    }
                );
            }
                ...
                localOrder.push(
                    {
                        ...
                        quantity: this.itemsInCart.length,
                        total_price: this.cartTotal,
                        order_channel_id: "3b696cbc-10ef-14ed-a261-0242ac120002",
                        items: this.itemsInCart,
                    }
                );
            }
